    ...
    return (
        <div className="p-4 md:p-8 bg-base-100 min-h-screen">
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-6 gap-4">
                <div>
                    <h2 className="text-3xl font-bold">Manage <span className="text-primary">Citizens</span></h2>
                            ...
                            <tr key={user._id} className="hover:bg-base-50 transition-colors">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="avatar">
                                            <div className="mask mask-squircle w-12 h-12 bg-base-300">
                                                <img src={user.photoURL || "https://i.ibb.co/Zm9J5M4/user-placeholder.png"} alt={user.displayName} />
                                            </div>
                                        </div>
                                        <div>
                                            <div className="font-bold text-base">{user.displayName || user.name || "Unknown Name"}</div>
                                ...
                                <td className="text-center">
                                    <button 
                                        ...
                                        className={`btn btn-sm px-4 shadow-sm border-none text-white transition-all duration-200 w-28
                                            ${user.isBlocked 
